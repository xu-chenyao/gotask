// testing 版本（放到 main_test.go；逻辑、顺序、打印与错误处理保持一致）
package main
...
func TestSepoliaBlockHeaderAndBody(t *testing.T) {
	client, err := ethclient.Dial("https://eth-sepolia.g.alchemy.com/v2/X0OaJKEZmL-QMvYnkhDwT")
	if err != nil {
		log.Fatal(err)
	}
